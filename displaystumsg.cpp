...
{
	return (a.score1 + a.score2+a.score3+a.score4) > (b.score1 + b.score2+b.score3+b.score4);
}
...
void displayStuMsg::sortWithStuAve()
{
	...
	ui->textBrowser->setText("按平均分倒序排序完毕");
	...
	//	ui->textBrowser->append(QString::number(it->score1));
	//	ui->textBrowser->append(QString::number(it->score2));
	//	ui->textBrowser->append(QString::number(it->score3));
	//	ui->textBrowser->append(QString::number(it->score4));
